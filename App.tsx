...
const App: React.FC = () => {
  ...
  // Auto Sync saat pertama kali dibuka
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      {isSyncing && (
        <div className="fixed top-0 left-0 w-full h-1 bg-emerald-300 z-[100] overflow-hidden">
          <div className="w-1/2 h-full bg-yellow-400 animate-[progress_1.5s_infinite_linear]"></div>
        </div>
      )}
      <style>{`
        @keyframes progress {
          ...
          <div className="max-w-6xl mx-auto px-4 h-16 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] opacity-70 font-bold uppercase tracking-widest">{state.currentUser?.group || 'Pusat'}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
